...
@section('content')
    <form action="/owner/report/{{ $motel->id }}" method="POST"> 
        @csrf
                ...
                <div class="detail-motel">
                    ...
                    <div style="display:flex">
                        <ul style="margin-top: 30px;">
                            ...
                            <li style=><span style="min-width: 130px;color: #919ba5;display: inline-block;margin-top: 10px;">Ngày đăng:</span> {{ $motel->updated_at->format('d-m-Y') }}</li>
                        </ul>
                    ...
                    <form action="/owner/review/{{ $motel->id }}" method="POST">
                        @csrf
