    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ route('admin.posts.add_post') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6 row" >
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="air_conditioning" >
                                            </div>
                                        </div>
                                        <div class="col-md-6 row">
                                            <label style="margin-top: 15px;margin-left: 92px;">Nóng lạnh:</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="hot_cold">
                                            </div>
                                        </div>
                                    </div>
