                            ...
                            {{-- @foreach ($likelist->motels as $motel) --}}
                                <li id="{{ $likelist->id }}">
                                    ...
                                    <div class="detail-motel">
                                        <div class="title">
                                            <a href="/renter/detail/{{$likelist->motel->id}}">
                                        ...
                                        <div class="more">
                                            <div class="post-date">Ngày đăng: {{ $likelist->motel->created_at->format('d-m-Y') }}</div>
                                            <div class="phone">
                                                <i class="fa fa-phone" aria-hidden="true" style="color: #00deb6">
                                                    <span style="color: black!important">
                                                        {{ $listlike->motel->owner->phone }}
                                                    </span>
                                                </i>
...
<script>
    function dislikes(id){
        ...
        $.ajax({
            type: 'get',
            url: 'http://localhost:8000/renter/dislikes/' + id,
